...
<body>
	<h2>회원가입</h2>
	<form action="MemeberJoinProc.jsp" method="post">
		<table width="600" border="1">
			...
			<tr height="40">
				...
				<td width="400" align="left">
					<input type="password" id="pass1" style="border: none; outline: none;"/>
				</td>
			</tr>
			<tr height="40">
				<td width="200" align="center">패스워드확인</td>
				<td width="400" align="left">
					<input type="password" id="pass2" style="border: none; outline: none;"/>
				</td>
			</tr>
			<tr height="40">
				<td width="200" align="center">이메일</td>
				<td width="400" align="left">
					<input type="text" id="email" style="border: none; outline: none;" />
				</td>
			</tr>
			<tr height="40">
